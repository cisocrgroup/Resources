Here you find the latest manuals for:

* the CIS Language Profiler (a server calculating statistical OCR error series based upon the OCR recognition result of a document, historical spelling patterns and language specific lexica of modern (and optionally also historical) wordforms written in C++
